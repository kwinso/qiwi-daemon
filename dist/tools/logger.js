...
exports.transactionsLogger = exports.logger = void 0;
...
const transactionsLogger = winston_1.default.createLogger({
    silent: loggerDisabled,
    transports: loggerDisabled ? undefined : [
        new winston_1.default.transports.File(loggingOptions.qiwiLevel),
    ],
});
exports.transactionsLogger = transactionsLogger;
