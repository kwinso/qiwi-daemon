...
class QiWiDaemon {
    ...
    connectStorage() {
        return new Promise((res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (storageType == "redis") {
                ...
                const exists = yield utils_1.FileUtils.fileExists(storageFileName);
                if (!exists) {
                    yield utils_1.JsonStorageUtils.createStorageFile(storageFileName);
    ...
    stop() {
        return __awaiter(this, void 0, void 0, function* () {
            clearTimeout(this.watchingProcess);
    ...
    saveSession(s) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.config.storage == "redis")
                ...
                utils_1.JsonStorageUtils.saveSession(s, this.config.jsonName);
            }
        });
    }
    getSessionId(comment) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.config.storage == "redis")
                ...
                const session = utils_1.JsonStorageUtils.getSession(comment, this.config.jsonName);
                if (session)
                    return session.id;
                else
                    return null;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((res) => {
                ...
                if (this.config.storage == "redis") {
                    ...
                    utils_1.JsonStorageUtils.deleteSession(keyword, this.config.jsonName);
                }
            });
        });
    }
    ...
    watch() {
        ...
        this.watchingProcess = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            ...
            if (transactions.data) {
                ...
                for (let payment of payments) {
                    ...
                    if (sessionId) {
                        ...
                        logger_1.transactionsLogger.log("info", `Payment for ${sessionId} has confirmed.`);
                    }
                }
            }
